...
export default function Regulationlicensing({ onBack }) {
        ...
        <div className="col-span-9 space-y-6">
          ...
          >
            ...
            <p className="text-[13px] text-white/70 max-w-[713px] leading-relaxed">
              Implement an agile regulatory framework that streamlines the setup
              of video game companies and launch a CX improvement program to
              address pain points and define best practices with feedback loops.
            </p>
          </div>
...
const STEP_GRADIENTS = [
  ...
  "linear-gradient(90deg, #F7CA7D 0%, #B2BB6F 100%)", // Step 3
  "linear-gradient(90deg, #B5BC70 0%, #3BAB78 100%)", // Step 4
];
