...
const SHEET_URL =
  "https://docs.google.com/spreadsheets/d/1zwMlxUzU9mQf20IOMYP9cCcnfDcqRYoO/export?format=csv&gid=1473437154";
...
export default function FormalEducation({ onBack }) {
  ...
  const mainKPI = kpis.filter((k) => k.name === "Employed graduates");

  const supportingKPIs = kpis.filter((k) => k.name !== "Employed graduates");
