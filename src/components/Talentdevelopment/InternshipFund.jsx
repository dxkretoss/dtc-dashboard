    ...
    <div className="w-full space-y-6 text-white">
      ...
      >
        <div className="flex items-center gap-3 mb-3">
          ...
          <h2 className="text-[18px] font-semibold">Internship fund</h2>
        </div>

        <p className="text-[13px] text-white/70 max-w-[900px] leading-relaxed">
          Establish an Internship Fund and structured placement program to help
          gaming companies offset hiring costs, expand internship opportunities
          for students (especially Emirati students) and make it easier for
          companies to bring in and train new gaming talent.
        </p>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-8 space-y-6">
          ...
          <GlassCard title="KPIs">
            ...
            <div className="grid grid-cols-1">
              <SupportingKPICard
                title="Fund allocated to intern placement"
                target="TBD"
              />
            </div>
          </GlassCard>
        ...
        <div className="col-span-4 space-y-6">
          ...
          <GlassCard title="Next steps">
            ...
            <NextStepRow
              activity="Define plan for internship placement"
              owner="AD Gaming"
              date="TBD"
              status="Delayed"
              danger
            />
            <NextStepRow
              activity="Obtain legal approval for MOU"
              owner="AD Gaming"
              date="TBD"
              status="Delayed"
              danger
            />
            <NextStepRow
              activity="Market intern program to companies"
              owner="DCT Legal"
              date="31/07"
              status="Not Started"
            />
