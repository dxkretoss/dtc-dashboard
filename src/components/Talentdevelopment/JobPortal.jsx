...
const SHEET_URL =
  "https://docs.google.com/spreadsheets/d/1zwMlxUzU9mQf20IOMYP9cCcnfDcqRYoO/export?format=csv&gid=1179530902";
        ...
        <div className="space-y-3 max-w-[761px]">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-[22px] font-semibold">Job portal</h2>
            </div>

            <p className="text-[13px] text-white/70 max-w-[713px] leading-relaxed">
              Establish a centralized gaming industry jobs portal to connect
              talent with jobs, internships, and apprenticeships, streamline
              recruitment, and help companies attract the right talent based on
              their needs.
            </p>
          </div>
          ...
          <div className="w-full">
            ...
            <Row
              id="1.1"
              title="Build job portal"
              partners={["MBZUH"]}
              engage={["NYU"]}
              mou={["ADU / Rubika"]}
              img={"./Build.svg"}
              completed
              desc={"Initiative not started, website dependency"}
            />
            ...
            <Row
              ...
              img={"./University.svg"}
              completed
              desc={"To start job portal is set up once"}
            />
          ...
          <div
            className="p-3 rounded-b-[16px] -mt-2"
            style={{
              background:
                "linear-gradient(180deg, rgba(255,255,255,0.08), rgba(255,255,255,0.03))",
            }}
