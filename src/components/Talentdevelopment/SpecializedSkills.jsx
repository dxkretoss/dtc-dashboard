...
const SHEET_URL =
  "https://docs.google.com/spreadsheets/d/1zwMlxUzU9mQf20IOMYP9cCcnfDcqRYoO/export?format=csv&gid=895804982";
...
export default function SpecializedSkills({ onBack }) {
  ...
  const mainKPI = kpis.find((k) => k.name === "Partnerships with Engines");

  const supportingKPIs = kpis.filter(
    (k) => k.name !== "Partnerships with Engines",
  );
        ...
        <div className="space-y-3 max-w-[761px]">
          ...
          >
            ...
            <p className="text-[13px] text-white/70 max-w-[713px] leading-relaxed">
              Develop specialized, hands-on vocational and up skilling programs
              in emerging technologies, engines, and AI for game development
              with certificates to boost employability
            </p>
          </div>
          ...
          <GlassCard title="Key companies">
            ...
            <div className="rounded-[16px] border border-white/10 overflow-hidden">
              {/* HEADER */}
              <div className="grid grid-cols-6 text-[12px] text-white">
                ...
                {[
                  ...
                  <div
                    key={t}
                    className={`px-2 py-3 text-[#FFFFFF] text-center ${
                    ...
                    <div className="flex items-end justify-between">
                      <div className="flex gap-2">
                        <span className="text-[#3BAB78] font-semibold text-[12px]">
                          {mainKPI?.actual} ({mainKPI?.percentMonthly}){" "}
                        </span>
                      ...
                      <GamingeventDonut
                        total={mainKPI.yearlyTarget}
                        green={mainKPI.actual}
                        blue={mainKPI.gapMonthly}
                      />
